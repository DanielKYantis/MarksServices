...
const SITE_NAME = "Sun City Home Repair";
const BUSINESS_NAME = "Sun City Home Repair";
const BUSINESS_EMAIL = "info@SunCityHomeRepair.com";
...
const BUSINESS_AREA = "Sun City & Berry Creek, Texas";
const BUSINESS_AREA_DETAIL = "Sun City, TX 78633 and Berry Creek 78628";
const BUSINESS_ADDRESS_DISPLAY =
    "Client-location service in " . BUSINESS_AREA_DETAIL;
const BUSINESS_SERVICE_NOTE = "Client-location service in Sun City 78633 and Berry Creek 78628.";
...
{
    $host = $_SERVER["HTTP_HOST"] ?? "suncityhomerepair.com";
    $https = $_SERVER["HTTPS"] ?? "";
